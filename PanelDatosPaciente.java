...
public class PanelDatosPaciente extends JPanel implements ActionListener{
    ...
    private InterfazSistemaPacientes principal;
        // etiquieta la zona para el nombre 

    // etiquieta la zona para el nombre 
    private JLabel labNombre;
    private JTextField txtNombre;
    // etiquieta la zona para el apellido 
    private JLabel labApellido;
    private JTextField txtApellido;
    // etiquieta la zona para la fecah de nacimiento 
    private JLabel labFNacimiento;
    private JTextField txtFNacimiento;
    // etiquieta la zona para el sexo
    private JLabel labSexo;
    private JTextField txtSexo;
    // etiquieta que se muestra la imagen  
    private JLabel labImagen;
    // etiquieta la zona para calcular la edad 
    private JButton butEdad;
    // etiquieta la zona donde se muestra la edad
